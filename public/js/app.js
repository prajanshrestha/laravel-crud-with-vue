...
vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_1___default().component("modal", {
  template: "#modal-template"
});
new (vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_1___default())({
  el: "#app",
  data: function data() {
    return {
      newItem: {
  ...
  methods: {
    ...
    editItem: function editItem() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/editItem/" + i_val.value, {
        val1: n_val.value,
        val2: a_val.value,
        val3: p_val.value
